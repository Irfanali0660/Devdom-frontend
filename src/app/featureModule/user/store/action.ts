...
export const addpost=createAction('Add post',props<{post:addpostinterface}>())
...
export const getsinglepostsuccess=createAction('getsinglepostsuccess',props<({singlepost:addpostinterface})>())
...
export const commentssuccess=createAction('commentsuccess',props<({data:Comments[]})>())
...
;
export const addnewlist=createAction('addnewlist',props<({formdata:Partial<addlistinterface>,tag:Array<string>,location:placeinterface})>())
